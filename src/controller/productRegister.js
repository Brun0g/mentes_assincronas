...
const productRegister = async (req, res) => {
  ...
  try {
    const result = await pool.query("INSERT INTO produtos (descricao, quantidade_estoque, valor, categoria_id) VALUES ($1, $2, $3, $4) RETURNING id, descricao, quantidade_estoque, valor, categoria_id", [
      descricao,
      quantidade_estoque,
      valor,
      categoria_id,
