...
routes.post("/produto", multer.single("produto_imagem"), categoryValidation, productRegister);
routes.get("/produto", listProducts);
routes.get("/produto/:id", productDetail);
routes.put("/produto/:id", multer.single("produto_imagem"), categoryValidation, productUpdate);
